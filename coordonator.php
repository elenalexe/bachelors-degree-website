...
<html lang="en">
    ...
    <body>
        ...
        <div class="container" style="margin-top: 100px;">
            <div class="row justify-content-center center_text_align">
                <div class="col-md-6 col-md-offset-3">
                    <p> <?php echo $lang['functie'] ?></p>
                    <p1> <?php echo $lang['numeC'] ?></p1>
                    <br>
                    <p2> <?php echo $lang['materii'] ?></p2>
        ...
        <div class="footer bg-dark">
            <a href="coordonator.php?lang=en"><?php echo $lang['lang_en'] ?></a> || <a
                href="coordonator.php?lang=ro"><?php echo $lang['lang_ro'] ?></a>
    </body>
